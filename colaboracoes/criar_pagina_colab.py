...
with open('posts_colab_final.html', 'w') as finalhtml:
    finalhtml.write('<DOCTYPE html> \n <head> \n <title>Backup Preparty - Colaboração </title> \n'
                    ...
                    '<h4 class="topic_name"> COLABORAÇÕES </h4> \n <hr>')

# abrir o arquivo de posts e ler
n = 0
with open('COLAB_cronologico_page.csv', 'rb') as csv_post:
    ...
    for i in range(len(id_list)):
        ...
        if id_list_split[i] not in lista_done:
            ...
            ref = 'colaboracoes/' + id_list_split[i] + '.html'

            with open('posts_colab_final.html', 'a') as html_duvidas:
...
with open('posts_colab_final.html', 'a') as rodape:
    rodape.write('\n </main> \n </body> \n </html>')
